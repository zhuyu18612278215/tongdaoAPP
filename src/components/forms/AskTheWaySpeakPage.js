/**
 * AskTheWaySpeakPage zhuyu 2018/5/10
 */
...
import style from '../../css/AskTheWaySpeakPageStyle';
...
const PAGE_WORD = {
  ...
  speakLabel: '道长说',
  listHeaderComponentText: '本栏目用来分享道长的修行心得',
};

export default class AskTheWaySpeakPage extends Component {
  constructor(props) {
    super(props);
